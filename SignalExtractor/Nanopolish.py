...
def nanopolish_events(fastDir, basecallDir, referenceFile="Data/", fastFile=None):
    ...
    os.system(sam_cmd)
    ref_cmd = "minimap2 -ax map-ont --split-prefix " + referenceFile + " /Data/basecall/flappie-basecalls.fq" + " | " + "samtools sort -o " + basecallDir + "reads-ref.sorted.bam -T " + basecallDir + "reads.tmp"
